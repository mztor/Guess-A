...
let arrays = pokemonTypes(
    ...
    water: ["Squirtle", "Wartortle", "Blastoise", "Psyduck", "Golduck", "Poliwag", "Poliwhirl", "Poliwrath", "Tentacool", "Tentacruel", "Slowpoke", "Slowbro", "Seel", "Dewgong", "Shellder", "Cloyster", "Krabby", "Kingler"],
    electric: ["Pikachu", "Raichu", "Magnemite", "Magneton", "Voltorb", "Electrode"],
    ...
    poison: ["Ekans", "Arbok", "Nidoran♀", "Nidorina", "Nidoqueen", "Nidoran♂", "Nidorino", "Nidoking", "Zubat", "Golbat", "Grimer", "Muk"],
    psychic: ["Abra", "Kadabra", "Alakazam", "Drowzee", "Hypno"],
    ice: [],
